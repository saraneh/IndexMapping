...
### Step One:
**Georeference the parent map in ArcMap.** This is the map which contains all the smaller, index maps. Make sure the right coordinate system is selected for your project (WGS 1984 is fine).
### Step Two:
